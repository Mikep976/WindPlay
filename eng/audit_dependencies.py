...
command = [os.environ.get("WINDPLAY_DOTNET", "dotnet"), "list", "tests/WindPlay.Protocol.Tests/WindPlay.Protocol.Tests.csproj",
...
print("No known advisories reported for the protocol/test dependency graph.")
