...
{
    private const string GetHex = "474554";
    private const string PostHex = "504F5354";

    [GeneratedRegex("474554|504F5354", RegexOptions.IgnoreCase)]
    private static partial Regex GenMethodPatternRegex();

    private static readonly Regex MethodPatternRegex = GenMethodPatternRegex();
    ...
    {
        if (hex.StartsWith(GetHex, StringComparison.OrdinalIgnoreCase))
            return HttpMethod.Get;
        else if (hex.StartsWith(PostHex, StringComparison.OrdinalIgnoreCase))
